...
NOTE: This file is prefixed with an underscore (_) so Airflow will ignore it.
When copying this file, remove the underscore from the filename.
"""
...
# Create DAG
# NOTE: This is a template file. The DAG creation is commented out to prevent Airflow from loading it.
# When copying this file, uncomment the DAG and task creation below and set a proper schedule_interval.
