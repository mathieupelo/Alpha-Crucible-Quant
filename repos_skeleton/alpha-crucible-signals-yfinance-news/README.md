...
1. Fetching yfinance news data from ORE database
2. Calculating signal scores from the data
...
```bash
docker build -t alpha-crucible-signals-yfinance-news .
docker run --env-file .env alpha-crucible-signals-yfinance-news
```
